...
plots. An example data set can be downloaded
[here](ftp://ftp.ncbi.nlm.nih.gov/geo/series/GSE69nnn/GSE69480/matrix).
This data is in the correct format. 
 
### LONGO():
The next step is to use the start the shiny interface of LONGO using: `LONGO()`
This will start the interface giving the main menu.
...
is tab separated, which is what the example data file uses. As the options related
