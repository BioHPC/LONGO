...
### LONGO():
The LONGO function allows the user to input initial variables complete an
initial analysis with the default inputs. Then the user can alter some of the 
variables used in the analysis. A general workflow is given below. Start the
shiny interface using:
```{}
    LONGO()
```
